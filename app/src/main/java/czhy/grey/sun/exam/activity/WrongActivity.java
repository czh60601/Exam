...
public class WrongActivity extends Activity {
    ...
    private final String FILE_CODE = "#0006";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                new QuestionInfoDialog((Question) parent.getAdapter().getItem(position),WrongActivity.this).show();
            }
        });
    ...
    private void refurbish() {
        ...
        Cursor cursor = DBManager.GetWrong(keys,type_codee, subject_code);
        ...
        questionList = new QuestionAdapter(dataList, WrongActivity.this);
